...
function creaInterfaccia() {
    ...
    var e = "";
    !1 === isMobileRotation
        ? (e += '<div id="btnPlayPausaRotazione2d" style="cursor:pointer; position: absolute; z-index:1000; left:10px; bottom: 10px; height: 50px; width: 50px; background-image: url(' + cartellaDipendenze + 'ico-pause.png); background-size: cover;"></div>', e += '<div style="position: absolute; z-index:1000;  right:10px; top: 10px; height: 70px; width: 70px; background-image: url(' + cartellaDipendenze + 'ico-rotate.png); background-size: cover;"></div>', e += '<div id="btnFullScreenRotazione2d" style="cursor:pointer; position: absolute; z-index:1000;  right:10px; bottom: 10px; height: 50px; width: 50px; background-image: url(' + cartellaDipendenze + 'ico-zoom.png); background-size: cover;"></div>')
        : (e += '<div id="btnPlayPausaRotazione2d" style="cursor:pointer; position: absolute; z-index:1000; right:10px; bottom: 10px; height: 50px; width: 50px; background-image: url(' + cartellaDipendenze + 'ico-pause.png); background-size: cover;"></div>', e += '<div style="position: absolute; z-index:1000; right:10px; top: 10px; height: 70px; width: 70px; background-image: url(' + cartellaDipendenze + 'ico-rotate_mobile.png); background-size: cover;"></div>'),
...
function togleFullScreenRotazione2d() {
    if (isFullScreen) {
        ...
        $("#btnFullScreenRotazione2d").css("background-image", "url(" + cartellaDipendenze + "ico-zoom.png)"),
        $("body").css("overflow-y", ""),
        isFullScreen = !1
    } else {
        ...
        contenitore
            ...
            .css("z-index", "100"),
        $("body").append(e),
        $("#btnFullScreenRotazione2d").css("background-image", "url(" + cartellaDipendenze + "ico-zoom_meno.png)"),
...
function togleRotazioneAutomatica() {
    rotazione2dAutomatica
        ? ($("#btnPlayPausaRotazione2d").css("background-image", "url(" + cartellaDipendenze + "ico-play.png)"), isPlay =! 1, rotazione2dAutomatica =! 1, myVideoPlayer.pause())
        : ($("#btnPlayPausaRotazione2d").css("background-image", "url(" + cartellaDipendenze + "ico-pause.png)"), isPlay =! 0, rotazione2dAutomatica =! 0, myVideoPlayer.play())
}
function inizializzaRotazione2D() {
    ...
    $("#imgPrincipale").bind("touchmove", function (e) {
        isPlay && mouseDownRotazione && (isPlay =! 1, rotazione2dAutomatica =! 1, myVideoPlayer.pause(), $("#btnPlayPausaRotazione2d").css("background-image", "url(" + cartellaDipendenze + "ico-play.png)")),
